<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="rpt_preview.aspx.vb" Inherits="report_rpt_preview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SampleContent" Runat="Server">
 <div class="demoarea">
        ...
        <CR:CrystalReportSource ID="CRS" runat="server">
            <Report FileName="rptPreview.rpt">
                <DataSources>
