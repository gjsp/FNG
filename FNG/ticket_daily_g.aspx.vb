...
Partial Class ticket_daily_g
    Inherits basePage
    Dim colBegin As Integer = 7
    Dim purityName As String = "96.50(กรัม)"
    ...
    Protected Sub btnSearchAdv_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearchAdv.Click
        Try
            ...
            objSrcTicket.SelectParameters("gold_type_id").DefaultValue = clsFng.p96g
    ...
    Protected Sub gvTicket_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvTicket.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            End If
            CType(e.Row.FindControl("link"), HyperLink).NavigateUrl = "ticket_deal_g.aspx?page=dialy&id=" + e.Row.DataItem("ticket_id").ToString
            ...
            e.Row.Cells(4).Text = purityName
            e.Row.Cells(5).Text = clsManage.convert2Currency(e.Row.DataItem("buy_price"))
            e.Row.Cells(5 + 1).Text = clsManage.convert2QuantityGram(e.Row.DataItem("buy_quantity"))
            ...
            e.Row.Cells(5 + 4).Text = clsManage.convert2QuantityGram(e.Row.DataItem("sell_quantity"))
        ...
        If e.Row.RowType = DataControlRowType.Footer Then
            ...
            If Double.Parse(ViewState("sumQuanSell96")) <> 0 Then
                averagePriceSell96 = Double.Parse(ViewState("sumAmountSell96")) / (Double.Parse(ViewState("sumQuanSell96")) / 15.244)
                ViewState("averagePriceSell96") = averagePriceSell96
            End If
            If Double.Parse(ViewState("sumQuanBuy96")) <> 0 Then
                averagePriceBuy96 = Double.Parse(ViewState("sumAmountBuy96")) / (Double.Parse(ViewState("sumQuanBuy96")) / 15.244)
            ...
            creatCels.Add("2", " " + purityName + ",1,1")
    ...
    Private Sub getMultiFooter(ByVal e As GridViewRowEventArgs, ByVal getCels As SortedList)
        ...
        While (enumCels.MoveNext)
            ...
            If enumCels.Key.ToString = "4" Or enumCels.Key.ToString = "7" Then
                cell.Controls.Add(New LiteralControl(clsManage.convert2QuantityGram(cont(0).ToString)))
            Else
    ...
    Protected Sub linkExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles linkExport.Click
        ...
        dt = clsDB.getTicketDialy(txtTicketRef.Text, txtBookNo.Text, txtNo.Text, txtCustName.Text, clsFng.p96g, pDate1, pDate2, txtDelDate1.Text, txtDelDate2.Text, txtPrice.Text, ddlSelf.SelectedValue, ddlTeam.SelectedValue, ddlRecycle.SelectedValue, status, txtAmount.Text, rdoType.SelectedValue, rdoCenter.SelectedValue)
        If dt.Rows.Count > 0 Then
            ...
            clsManage.ExportSummaryOrderOrnamentToPDF(dt, "Summary_Order_Ornament_" + txtDate.Text, htSum, Server.MapPath(""))
        End If
    End Sub
