...
Partial Class user_detail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Request.QueryString("id") IsNot Nothing Then
                If Request.QueryString("id").ToString = "pf" Then
                    hdfUser_id.Value = Session(clsManage.iSession.user_id_center.ToString).ToString
                Else
                    hdfUser_id.Value = Request.QueryString("id").ToString
                End If
            End If
        ...
        If Request.QueryString("id") IsNot Nothing Then
            script = "trRef.style.display='block';"

            If Request.QueryString("id").ToString = Session(clsManage.iSession.user_id_center.ToString).ToString Then
                script += "trPwd.style.display='block';"
            Else
                script += "trPwd.style.display='none';"
            End If
        Else
            script = "trRef.style.display='none';"

        End If
        If script <> "" Then
            clsManage.Script(Page, script, "display")
        End If
    End Sub
        ...
        Try
            ...
            Else
                ...
                If u IsNot Nothing Then
                    ...
                    End If
                    dc.SubmitChanges()
                    clsManage.alert(Page, "Update complete.", , "users.aspx")
                End If
            End If
        Catch ex As Exception
            clsManage.alert(Page, ex.Message)
    ...
    Function validatetion() As Boolean
        ...
        'If ddlPos.SelectedIndex = 0 Then clsManage.alert(Page, clsManage.msgRequiredFill, txtFname.ClientID) : Return False
