...
Partial Class ticket_payment_detail
        ...
        If Not Page.IsPostBack Then
            If Request.QueryString("pid") IsNot Nothing Then
                ...
                If pms IsNot Nothing Then
                    ...
                    dt = clsFng.getPaymentDetail(pid)
                    ViewState("dt") = dt
    ...
    Protected Sub linkAdd_Click(sender As Object, e As EventArgs) Handles linkAdd.Click
        Try
            ...
            Dim dt As New Data.DataTable
            dt = clsFng.getPaymentDetailPopUp(refNoList, ViewState("id").ToString.Split(",")(0), ViewState("id").ToString.Split(",")(1), ViewState("id").ToString.Split(",")(2))
