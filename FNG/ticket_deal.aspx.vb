...
Partial Class ticket_deal
    ...
    Protected Sub btnDealTicket_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDealTicket.Click
        Try
            ...
            Dim result As String = clsDB.insertTicket(txtCustRef.Text, "", "", Session(clsManage.iSession.user_id_center.ToString), rdoGoldType.SelectedValue, rdoType.SelectedValue, _
            ...
            If result <> "" Then
                clsManage.alert(Page, "Deal Ticket Complete Reference No : " & result & "|nCustomer Name : " + ucPortFolio1.Name + " |nPurity : " + rdoGoldType.SelectedItem.Text + " |nType : " + rdoType.SelectedItem.Text + " |nPrice : " + txtPrice.Text + "|nQuantity : " + txtQuan.Text + "", , "stock_tickets.aspx")
            Else
    ...
    Function validatetion() As Boolean
        ...
        'If Not clsDB.checkDupTicket(txtBookNo.Text, IIf(Request.QueryString("id") Is Nothing, "new", "update"), rdoType.SelectedValue, hdfType.Value) Then
        '    clsManage.alert(Page, "Book No. already in system.")
        '    Return False
        'End If
        ...
        If cbGoldDep.Checked And rdoType.SelectedValue = "buy" Then
            ...
            If rdoGoldType.SelectedValue = "96" Then
                quan_gold = clsManage.convert2zero(ucPortFolio1.Gold96)
            Else
                quan_gold = clsManage.convert2zero(ucPortFolio1.Gold99)
            End If
