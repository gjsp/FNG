<%@ Page Language="VB" MasterPageFile="~/trade/admin/MasterPageAdmin.master" AutoEventWireup="false"
    CodeFile="manage_sales.aspx.vb" Inherits="admin_manage_sales" Title="Manage Sales" %>
        ...
        <ContentTemplate>
            <div style="width: 600px;" class="adminarea">
                ...
                <div style="padding-top: 7px;">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getUserSales"
