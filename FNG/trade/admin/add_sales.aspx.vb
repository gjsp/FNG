...
Partial Class admin_add_sales
    ...
    Function saveData() As Boolean
        Try
            ...
            Else
                ...
                Else
                    clsMain.InsertUsernames(UserTxtbox.Text, PassTxtbox.Text, "sale", Session(clsManage.iSession.user_id.ToString).ToString, "", "", "", "n")
                    Return True
                End If
    ...
    Protected Sub Addbt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Addbt.Click
        Try
            If saveData() Then
                clsManage.alert(Page, "Save Complete", , "manage_sales.aspx")
            End If
        Catch ex As Exception
            clsManage.alert(Page, ex.Message)
        End Try
