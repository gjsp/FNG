<%@ Page Language="VB" MasterPageFile="~/trade/admin/MasterPageAdmin.master" AutoEventWireup="false" CodeFile="add_admin.aspx.vb" Inherits="admin_add_admin" title="Manage Admin" %>
