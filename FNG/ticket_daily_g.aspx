<%@ Page Language="VB" MasterPageFile="~/DefaultMaster.master" AutoEventWireup="false"
    CodeFile="ticket_daily_g.aspx.vb" Inherits="ticket_daily_g" Title="ticket_daily" %>
                            ...
                            <asp:GridView ID="gvTicket" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:BoundField DataField="book_no" HeaderText="book_no" SortExpression="book_no">
                                    ...
                                    <asp:BoundField DataField="buy_quantity" HeaderText="Quan" DataFormatString="{0:#,##0.000}"
                                    ...
                                    <asp:BoundField DataField="sell_quantity" HeaderText="Quan" DataFormatString="{0:#,##0.000}"
